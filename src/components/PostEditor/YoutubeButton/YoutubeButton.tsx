...
const YoutubeButton = ({editor}: {editor: Editor | null}):JSX.Element => {
  ...
  return (
    <Popover width={300} trapFocus position="bottom" withArrow shadow="md" opened={opened} onClose={handleClose}>
              <Popover.Target>
                <div className={styles.videoButton} onClick={handleOpen}><IconBrandYoutube size={17} strokeWidth="1.2" /></div>
              </Popover.Target>
              ...
              <TextInput
                  ...
                  <div
                    ...
                    className={styles.saveYoutubeLink}
                  >
                    Save
                  </div>
              </Popover.Dropdown>
